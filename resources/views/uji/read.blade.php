...
@section('content')
    ...
    <a href="{{ route('uji.data') }}" class="btn btn-dark" style="margin-left: 20px; width: 150px">Uji Data</a>
    ...
    <form method="post" action="{{ route('uji.data') }}" enctype="multipart/form-data">
        @csrf
