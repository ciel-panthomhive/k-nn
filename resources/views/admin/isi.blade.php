...
<body id="body-pd">
    ...
    <div class="l-navbar" id="nav-bar">
        <nav class="nav">
            <div> <a href="{{ url('/') }}" class="nav_logo"> <img src="{{ asset('assets/images/logo2.png') }}"
                        style="width:25px"> <span class="nav_logo-name">BIRAWA CELL</span> </a>

                <div class="nav_list">
                    <a href="{{ route('home') }}" class="nav_link active"> <i class='bx bx-grid-alt nav_icon'></i> <span
                            class="nav_name">Data Testing</span> </a>
                    <a href="{{ route('uji.read') }}" class="nav_link"> <i class='bx bx-bar-chart-alt-2 nav_icon'></i>
                        <span class="nav_name">Uji</span>
                    </a>
                    <a href="{{ route('profil', ['id' => Auth::user()->id]) }}" class="nav_link"> <i
                            class='bx bx-user nav_icon'></i> <span class="nav_name">Profil</span> </a>
